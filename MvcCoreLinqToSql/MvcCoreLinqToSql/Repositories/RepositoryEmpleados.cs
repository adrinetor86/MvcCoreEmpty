...
{
    //SOLO TEMDREMOS UNA TABLA A NIVEL DE CLASE PARA 
    //NUESTRAS CONSULTAS
    ...
    public List<Empleado> GetEmpleadosOficiosSalario(string oficio, int salario)
    {
        var consulta = from datos
                in this.tablaEmpleados.AsEnumerable()
    ...
    public ResumenEmpleado GetEmpleadosOficio(string oficio)
    {
        ...
        if (consulta.Count() == 0)
        {
            ...
            resumen.Personas = 0;
            resumen.MaximoSalario = 0;
            resumen.MediaSalarial= 0;
            resumen.Empleados= null;
            return resumen;
        }
        else
        {
    ...
    public List<string> GetOficios()
    {
        ...
        //AHORA YA TENEMOS LO QUE NECESITAMOS, UN CONJUNTO DE 
        //STRING
